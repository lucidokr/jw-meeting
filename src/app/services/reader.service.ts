...
export class ReaderService {
  ...
  add(brother: Brother): Observable<string> {
    return this.http.post<string>(environment.url + this.url +"/"+brother._id, brother.reader, {responseType: 'json'})
  }

  edit(brother: Brother): Observable<string> {
    return this.http.put<string>(environment.url + this.url +"/"+brother._id, brother.reader, {responseType: 'json'})
  }
